...
class ProQuizState(TypedDict):
    ...
    rag_chunks: list[dict]                  # [{index, content, similarity}] — raw chunks for distributor
    hotspot_items: list[str]               # list of hotspot strings — for distributor to assign individually
    few_shot_pool: dict[str, list[dict]]   # qtype -> list of examples — for rule-based distribution
