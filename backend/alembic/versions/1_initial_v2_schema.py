...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "kb_type", sqlmodel.sql.sqltypes.AutoString(length=20), nullable=False
        ),
        sa.Column(
            "share_code", sqlmodel.sql.sqltypes.AutoString(length=12), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_knowledge_bases_owner_id"),
        "knowledge_bases",
        ["owner_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column("user_id", sa.Integer(), nullable=False),
        sa.Column(
            "share_type", sqlmodel.sql.sqltypes.AutoString(length=20), nullable=False
        ),
        sa.Column(
            "share_token", sqlmodel.sql.sqltypes.AutoString(length=64), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_profile_shares_user_id"), "profile_shares", ["user_id"], unique=False
    )
    op.create_table(
        "study_circles",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.Column(
            "invite_code", sqlmodel.sql.sqltypes.AutoString(length=12), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_study_circles_creator_id"),
        "study_circles",
        ["creator_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "question_type", sqlmodel.sql.sqltypes.AutoString(length=30), nullable=False
        ),
        sa.Column(
    ...
    op.create_index(
        op.f("ix_bank_questions_knowledge_base_id"),
        "bank_questions",
        ["knowledge_base_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_circle_members_circle_id"),
        "circle_members",
        ["circle_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_circle_members_user_id"), "circle_members", ["user_id"], unique=False
    )
    op.create_table(
        "kb_acquisitions",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.Column("knowledge_base_id", sa.Integer(), nullable=False),
        sa.Column(
            "acquired_via", sqlmodel.sql.sqltypes.AutoString(length=20), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_kb_acquisitions_knowledge_base_id"),
        "kb_acquisitions",
        ["knowledge_base_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_kb_acquisitions_user_id"), "kb_acquisitions", ["user_id"], unique=False
    )
    op.create_table(
        "kb_folders",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_kb_folders_knowledge_base_id"),
        "kb_folders",
        ["knowledge_base_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_quiz_sessions_creator_id"),
        "quiz_sessions",
        ["creator_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "file_type", sqlmodel.sql.sqltypes.AutoString(length=20), nullable=False
        ),
        sa.Column(
    ...
    op.create_index(
        op.f("ix_quiz_questions_session_id"),
        "quiz_questions",
        ["session_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_kb_chunks_document_id"), "kb_chunks", ["document_id"], unique=False
    )
    op.create_index(
        op.f("ix_kb_chunks_knowledge_base_id"),
        "kb_chunks",
        ["knowledge_base_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_quiz_responses_question_id"),
        "quiz_responses",
        ["question_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_quiz_responses_session_id"),
        "quiz_responses",
        ["session_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_quiz_responses_user_id"), "quiz_responses", ["user_id"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_kb_acquisitions_knowledge_base_id"), table_name="kb_acquisitions"
    )
    ...
    op.drop_index(
        op.f("ix_bank_questions_knowledge_base_id"), table_name="bank_questions"
    )
