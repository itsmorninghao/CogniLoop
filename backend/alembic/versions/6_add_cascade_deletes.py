...
def upgrade() -> None:
    ...
    op.drop_constraint(
        "kb_folders_knowledge_base_id_fkey", "kb_folders", type_="foreignkey"
    )
    op.create_foreign_key(
        "kb_folders_knowledge_base_id_fkey",
        "kb_folders",
        "knowledge_bases",
        ["knowledge_base_id"],
        ["id"],
    ...
    op.drop_constraint(
        "kb_documents_knowledge_base_id_fkey", "kb_documents", type_="foreignkey"
    )
    op.create_foreign_key(
        "kb_documents_knowledge_base_id_fkey",
        "kb_documents",
        "knowledge_bases",
        ["knowledge_base_id"],
        ["id"],
    ...
    op.drop_constraint(
        "kb_documents_folder_id_fkey", "kb_documents", type_="foreignkey"
    )
    op.create_foreign_key(
        "kb_documents_folder_id_fkey",
        "kb_documents",
        "kb_folders",
        ["folder_id"],
        ["id"],
    ...
    op.drop_constraint(
        "kb_chunks_knowledge_base_id_fkey", "kb_chunks", type_="foreignkey"
    )
    op.create_foreign_key(
        "kb_chunks_knowledge_base_id_fkey",
        "kb_chunks",
        "knowledge_bases",
        ["knowledge_base_id"],
        ["id"],
    ...
    op.drop_constraint(
        "profile_shares_user_id_fkey", "profile_shares", type_="foreignkey"
    )
    op.create_foreign_key(
        "profile_shares_user_id_fkey",
        "profile_shares",
        "users",
        ["user_id"],
        ["id"],
    ...
    op.drop_constraint(
        "quiz_questions_session_id_fkey", "quiz_questions", type_="foreignkey"
    )
    op.create_foreign_key(
        "quiz_questions_session_id_fkey",
        "quiz_questions",
        "quiz_sessions",
        ["session_id"],
        ["id"],
    ...
    op.drop_constraint(
        "quiz_responses_session_id_fkey", "quiz_responses", type_="foreignkey"
    )
    op.create_foreign_key(
        "quiz_responses_session_id_fkey",
        "quiz_responses",
        "quiz_sessions",
        ["session_id"],
        ["id"],
    ...
    op.drop_constraint(
        "circle_members_circle_id_fkey", "circle_members", type_="foreignkey"
    )
    op.create_foreign_key(
        "circle_members_circle_id_fkey",
        "circle_members",
        "study_circles",
        ["circle_id"],
        ["id"],
    ...
    op.drop_constraint(
        "circle_session_participants_session_id_fkey",
